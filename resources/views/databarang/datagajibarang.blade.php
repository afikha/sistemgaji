        ...
        <form class="form-inline" method="GET" action="{{ route('indexGajiBarang', $karyawan_id) }}">
          <div class="form-group mb-2 ml-5">
            ...
            <select class="form-control ml-3" name="minggu" id="minggu">
              ...
              <option value="{{ $week }}" {{ request()->get('minggu') == $week ? 'selected' : '' }}>
                Minggu {{ $week }}
              </option>
              @endforeach
            </select>
                    ...
                    <tr>
                      ...
                      <td>
                        <center>
                          ...
                          <a onclick="return confirm('Yakin Hapus?')" class="btn btn-sm btn-danger" href="{{route('deleteGajiBarang',$d->id)}}">
